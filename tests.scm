...
(map abs (list -1 -.1 3 4))
; expect (1 0.1 3 4)

(define add_num (mu (num) (+ num y)))
(define add2_numy (lambda (num y) (add_num (+ num num))))
(add2_numy 4 5)
; expect 13
...
((lambda (b c) (+ b (sqrt c))) 2 8)
; expect 4.828468571880147

(enumerate-interval 1 4)
; expect (1 2 3 4)

(count-leaves (list x x x x x))
; expect 5 

(begin (display 8) ((lambda (x) (* x 15)) 8))
; expect 8120
...
(accumulate cons nil (list 5 7 9 11))
; expect (5 7 9 11)
